...
func lesserAIV(x *AI, y V) V {
	...
	case *AV:
		...
		for i := range r.Slice {
			ri := lesserIV(int(x.At(i)), yv.At(i))
			if ri.IsErr() {
				return ri
			}
			r.Slice[i] = ri
...
func greaterAIV(x *AI, y V) V {
	...
	case *AV:
		...
		for i := range r.Slice {
			ri := greaterIV(int(x.At(i)), yv.At(i))
			if ri.IsErr() {
				return ri
			}
			r.Slice[i] = ri
...
func addABV(x *AB, y V) V {
	...
	case *AB:
		...
		r := make([]int, yv.Len())
		for i := range r {
			r[i] = int(B2I(x.At(i)) + B2I(yv.At(i)))
		}
		return NewAI(r)
	case *AF:
		if x.Len() != yv.Len() {
	...
	case *AI:
		...
		r := yv.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(B2I(x.At(i)) + yv.At(i))
		}
		return NewV(r)
	case *AV:
		if x.Len() != yv.Len() {
...
func addAIV(x *AI, y V) V {
	...
	case *AB:
		...
		r := x.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(x.At(i) + B2I(yv.At(i)))
		}
		return NewV(r)
	case *AF:
		if x.Len() != yv.Len() {
...
func subtractAIV(x *AI, y V) V {
	...
	case *AV:
		...
		for i := range r.Slice {
			ri := subtractIV(int(x.At(i)), yv.At(i))
			if ri.IsErr() {
				return ri
			}
			r.Slice[i] = ri
...
func multiplyAIV(x *AI, y V) V {
	...
	case *AV:
		...
		for i := range r.Slice {
			ri := multiplyIV(int(x.At(i)), yv.At(i))
			if ri.IsErr() {
				return ri
			}
			r.Slice[i] = ri
...
func divideAIV(x *AI, y V) V {
	...
	case *AV:
		...
		for i := range r.Slice {
			ri := divideIV(int(x.At(i)), yv.At(i))
			if ri.IsErr() {
				return ri
			}
			r.Slice[i] = ri
...
func minimumABV(x *AB, y V) V {
	...
	case *AI:
		...
		r := yv.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(minI(B2I(x.At(i)), yv.At(i)))
		}
		return NewV(r)
	case *AV:
		if x.Len() != yv.Len() {
...
func minimumAIV(x *AI, y V) V {
	...
	case *AB:
		...
		r := x.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(minI(x.At(i), B2I(yv.At(i))))
		}
		return NewV(r)
	case *AF:
		if x.Len() != yv.Len() {
	...
	case *AI:
		...
		r := x.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(minI(x.At(i), yv.At(i)))
		}
		return NewV(r)
	case *AV:
		if x.Len() != yv.Len() {
		...
		for i := range r.Slice {
			ri := minimumIV(int(x.At(i)), yv.At(i))
			if ri.IsErr() {
				return ri
			}
			r.Slice[i] = ri
...
func maximumABV(x *AB, y V) V {
	...
	case *AI:
		...
		r := yv.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(maxI(B2I(x.At(i)), yv.At(i)))
		}
		return NewV(r)
	case *AV:
		if x.Len() != yv.Len() {
...
func maximumAIV(x *AI, y V) V {
	...
	case *AB:
		...
		r := x.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(maxI(x.At(i), B2I(yv.At(i))))
		}
		return NewV(r)
	case *AF:
		if x.Len() != yv.Len() {
	...
	case *AI:
		...
		r := x.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(maxI(x.At(i), yv.At(i)))
		}
		return NewV(r)
	case *AV:
		if x.Len() != yv.Len() {
		...
		for i := range r.Slice {
			ri := maximumIV(int(x.At(i)), yv.At(i))
			if ri.IsErr() {
				return ri
			}
			r.Slice[i] = ri
...
func modulusABV(x *AB, y V) V {
	...
	case *AB:
		...
		r := make([]int, yv.Len())
		for i := range r {
			r[i] = int(modI(B2I(x.At(i)), B2I(yv.At(i))))
		}
		return NewAI(r)
	case *AF:
		if x.Len() != yv.Len() {
	...
	case *AI:
		...
		r := yv.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(modI(B2I(x.At(i)), yv.At(i)))
		}
		return NewV(r)
	case *AV:
		if x.Len() != yv.Len() {
...
func modulusAIV(x *AI, y V) V {
	...
	case *AB:
		...
		r := x.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(modI(x.At(i), B2I(yv.At(i))))
		}
		return NewV(r)
	case *AF:
		if x.Len() != yv.Len() {
	...
	case *AI:
		...
		r := x.reuse()
		for i := range r.Slice {
			r.Slice[i] = int(modI(x.At(i), yv.At(i)))
		}
		return NewV(r)
	case *AV:
		if x.Len() != yv.Len() {
		...
		for i := range r.Slice {
			ri := modulusIV(int(x.At(i)), yv.At(i))
			if ri.IsErr() {
				return ri
			}
			r.Slice[i] = ri
